...
class LotteryGames(Enum):
    ...
    LOTTO_PLUS_1 = {
                       ...
                       "how_to_play": {
                           "quick_pick": """
                    You can play the LOTTO Plus 1 game
                    ...
                    \nStep 1: Find a valid LOTTO Bet-slip.
                    \nStep 2: Using a pen / pencil, choose 6 numbers from 1 to 52 numbers
                    on any board by marking your choice of numbers.
                    \nStep 3: Take your Bet-slip to a teller at an approved 
                    ...
                    \nStep 6: Look out for the next LOTTO Draw on SABC 2, Wed /Sat at 20h57 to see if you have won.
                    """
                       },
                       "number_picking_rules": {
                           "normal_numbers": {
